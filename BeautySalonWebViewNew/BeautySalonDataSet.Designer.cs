...
namespace BeautySalonWebView {
    ...
    public partial class BeautySalonDataSet : global::System.Data.DataSet {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public OrdersRow AddOrdersRow(int clientId, int number, int status, System.DateTime DateCreate) {
        ...
        public partial class OrdersRow : global::System.Data.DataRow {
            ...
            public System.DateTime DateCreate {
                get {
                    return ((global::System.DateTime)(this[this.tableOrders.DateCreateColumn]));
                }
                set {
...
namespace BeautySalonWebView.BeautySalonDataSetTableAdapters {
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Orders] ([clientId], [number], [status], [DateCreate]) VALUES " +
                "(@clientId, @number, @status, @DateCreate)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Orders] SET [clientId] = @clientId, [number] = @number, [status] = " +
                "@status, [DateCreate] = @DateCreate WHERE (([id] = @Original_id))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, clientId, number, status, DateCreate FROM dbo.Orders";
        ...
        public virtual int Insert(int clientId, int number, int status, System.DateTime DateCreate) {
        ...
        public virtual int Update(int clientId, int number, int status, System.DateTime DateCreate, int Original_id) {
